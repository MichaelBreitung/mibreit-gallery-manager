...
from modules.gallery_tools import (
    is_gallery_path,
    get_list_of_supported_images_in_folder,
)
...
class TestGalleryImageElement(unittest.TestCase):
    ...
    def test_is_gallery_path_images_missing(self):
        self.assertEqual(is_gallery_path(no_gallery_folder_images_missing), False)

    def test_is_gallery_path_gallery_missing(self):
        self.assertEqual(is_gallery_path(no_gallery_folder_file_gallery_missing), False)

    def test_get_list_of_supported_images_in_folder_returns_only_jpg(self):
        self.assertEqual(
            get_list_of_supported_images_in_folder(images_folder), valid_images
        )
